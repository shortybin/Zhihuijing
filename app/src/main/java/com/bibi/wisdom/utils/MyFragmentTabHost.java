...
public class MyFragmentTabHost extends TabHost
    ...
    public static final class TabInfo {
        ...
        public void setClss(@NonNull Class<?> _class){
            this.clss=_class;
        }
    }
    ...
    public void changeTabFragment(TabInfo tabInfo, Class<? extends Fragment> clss){
        if(tabInfo==null)
            return;
        tabInfo.clss=clss;

        if(mLastTab!=tabInfo){ //不是当前标签
            ...
            tabInfo.fragment= Fragment.instantiate(mContext,
                    tabInfo.clss.getName(), tabInfo.args);
            ft.add(mContainerId, tabInfo.fragment,tabInfo.tag);
            ft.commit();
        }
